import { handleUpload, type HandleUploadBody } from '@khulnasoft/blob/client';
...
export async function handleUploadHandler(
  ...
  try {
    const jsonResponse = await handleUpload({
      body,
      request,
      // token: KHULNASOFT_BLOB_READ_WRITE_TOKEN,
      ...
      // eslint-disable-next-line @typescript-eslint/require-await -- [@khulnasoft/style-guide@5 migration]
